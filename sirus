...
function Tab:CreateToggle(ToggleSettings)
	...
	local ToggleTitleColor = ToggleSettings.Warning and Color3.fromRGB(196, 176, 84) or SelectedTheme.TextColor
	...
	if ToggleSettings.ColorPicker then
        ...
        MainCP.Name = "MainCP"
        MainCP.Size = UDim2.new(1, -20, 0, 110)  -- Smaller (was 120)
		...
		-- FIX: Mini Rayfield-style toggle for rainbow
		...
		-- Mini switch - same style as main toggle
...
ColorPickerButton.MouseButton1Click:Connect(function()
			...
			if ColorPickerOpen then
				...
				if ColorPickerFrame:FindFirstChild("RainbowToggle") then
					ColorPickerFrame.RainbowToggle.Visible = true
				end
				if useMobileSizing then
					TweenService:Create(ColorPickerFrame, TweenInfo.new(0.3, Enum.EasingStyle.Exponential), {Size = UDim2.new(0, 230, 0, 180)}):Play()
				else
					TweenService:Create(ColorPickerFrame, TweenInfo.new(0.3, Enum.EasingStyle.Exponential), {Size = UDim2.new(0, 230, 0, 231)}):Play()
				end
			else
				ClosePicker()
			end
